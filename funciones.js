...
(function (General) {
    ...
    General.cambioVehiculo = cambioVehiculo;
    ...
    function guardar() {
        ...
        var cantPuertas = document.getElementById("cantPuertas").value;
        var idRow;
        ...
        switch (document.getElementById("tipoVehiculo").value) {
            case "1":
                var miAuto = new General.Auto(marca, modelo, precio, cantPuertas);
                ...
                break;
            case "2":
                var miCamioneta = new General.Camioneta(marca, modelo, precio, cuatroXcuatro);
    ...
    function promedio() {
        var total = listaVehiculos.reduce(function (total, user) {
